...
No, se manejan permisos diferenciados por el rol, el cliente solo lee o crea su propio turno, el cajero solo gestiona los turnos asignados a su ventanilla y solo el administrador tiene permisos de configuración del sistema.
